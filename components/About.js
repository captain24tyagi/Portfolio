  ...
  return (
    ...
    className="flex flex-col font-mono relative text-center h-screen items-center md:flex-row max-w-7xl justify-evenly mx-auto">
        ...
        <div className='space-y-8 px-0 md:px-20'>
          ...
          <p className='space-y-10 text-xs md:text-md xl:w-[600px] xl:h-[300px] md:w-[400px] md:h-[200px]'>Myself Sarthak Tyagi, a web-developer, currently pursuing my B.Tech from SRM Institute of Science and Technology, Ramapuram, Chennai, IIIrd year, in computer science and engineering. Born and brought up in Delhi, i did my schooling from ASN Senior Secondary School, Mayur vihar, Delhi. About me, i just love being surrounded by my friends, to hang out with them and to interact with people as much as i can, as it's only through interaction that you can share thoughts and get to know various other things going there in the world and how people approach certain set of things and situations. I am a kind of person who loves to lead and the guy who stongly believes in teamwork, as i believe if someone who can do wonders individually, then a group  of such individuals can together make phenomenol stuff. A patriot from my childhood, I am always very passionate about armed forces</p>
        </div>
    </motion.div>
  )
}