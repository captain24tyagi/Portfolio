...
export default function Skilll({ directionLeft, skill, skillprog }) {
  return (
    <div className='group relative flex cursor-pointer'>
        ...
        <div className='absolute opacity-0 group-hover:opacity-70 transition-duration-300 ease-in-out group-hover: bg-white h-10 w-10 md:h-20 md:w-20 rounded-full'>
